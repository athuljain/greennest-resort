        ...
        <Row>
          <Col md={4} className="mb-4">
            ...
            <p className="footer-text">
              Discover tranquility and sustainable luxury nestled between the
          ...
          <Col md={4} className="mb-4 footer-contact-col">
            ...
            <ul className="list-unstyled footer-list">
              ...
              <li>
                ...
                <a href="mailto:info@greenoasis.com" className="footer-link">
            ...
            <div className="social-footer mt-3">
              <a
                ...
                aria-label="Facebook"
              >
                <FaFacebook className="social-footer-icon" />
              </a>
              <a
              ...
              >
                <FaInstagram className="social-footer-icon" />
              </a>
              <a
                ...
                aria-label="Twitter"
              >
                <FaTwitter className="social-footer-icon" />
              </a>
            </div>
          </Col>
        </Row>
