...
export default function Booking() {
  ...
  const handleSubmit = (e) => {
    ...
    alert(
      `Booking requested for ${formData.guests} guests from ${formData.checkIn} to ${formData.checkOut}.`
    );
  };
  ...
  const packages = [
    {
      value: "standard",
      label: "Standard Room - $250/night",
      details: "Access to basic amenities and complimentary breakfast.",
    },
    {
      value: "deluxe",
      label: "Deluxe Suite - $450/night",
      details: "Spacious room, ocean view, and exclusive spa access.",
    },
    {
      value: "villa",
      label: "Private Villa - $800/night",
      details:
        "Full private villa with pool, concierge service, and all-inclusive dining.",
    },
  ];

  return (
    <div
      className="booking-section py-5"
      style={{ backgroundImage: `url(${bookingBgImg})` }}
    >
          ...
          <Row>
            ...
            <Col lg={5} className="mb-4 mb-lg-0">
              <Card className="package-details-card h-100 shadow-lg border-0">
                <Card.Body>
                  <h3 className="fw-bold mb-4 text-green">
